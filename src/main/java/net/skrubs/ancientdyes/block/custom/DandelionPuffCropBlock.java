...
public class DandelionPuffCropBlock extends CropBlock {
    ...
    public DandelionPuffCropBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockState withAge(int age) {
        return age == 2 ? ModBlocks.DANDELION_PUFF.getDefaultState() : super.withAge(age);
    }
